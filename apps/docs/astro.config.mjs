	...
	integrations: [
		...
		starlight({
			...
			components: {
				...
				// Replaces Starlight's native <select> with a Light/Auto/Dark
				// segmented control. It owns the theme logic that used to live in
				// upstream's component — read that file before changing either.
