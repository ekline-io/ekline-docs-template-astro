 ...
 * entirely. A bare directory check would happily return either. The candidate
 * order follows from the same worry: the adapter-specific paths are checked
 * first, so a stale `dist/` can never shadow the output this build produced.
 *
