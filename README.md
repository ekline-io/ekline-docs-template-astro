...
**Live preview:** <https://potluck-docs-demo.vercel.app/> — with the
demo login enabled, so you can sign in as a fake reader and see the private and
per-org docs work.

**Documentation:** <https://potluck-docs.vercel.app> —
...
| [`apps/docs/`](./apps/docs) | The hosted documentation for the template — how to configure it, what every setting does. Built with the template itself. Live at <https://potluck-docs.vercel.app>. |
